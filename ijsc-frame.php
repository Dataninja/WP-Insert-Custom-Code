...
<html>
	...
	<ul id='sidemenu' style="margin-left: 100px;">
            <li id='tab-ijsc-ctag'><a href='' data-child="ijsc-insertCtag"><?php _e('Custom Tags', 'ijsc'); ?></a></li>
            <li id='tab-ijsc-datalink'><a href='' data-child="ijsc-insertData"><?php _e('External Data', 'ijsc'); ?></a></li>
            <li id='tab-ijsc-rawdata'><a href='' data-child="ijsc-insertRawData"><?php _e('Raw Data', 'ijsc'); ?></a></li>
            <li id='tab-ijsc-jslib'><a href='' data-child="ijsc-insertJSlib"><?php _e('JS Libs', 'ijsc'); ?></a></li>
            <li id='tab-ijsc-js'><a href='' class="current" data-child="ijsc-insertJS"><?php _e('JavaScript', 'ijsc'); ?></a></li>
            <li id='tab-ijsc-csslink'><a href='' data-child="ijsc-insertCSSlink"><?php _e('CSS Links', 'ijsc'); ?></a></li>
        ...
        <div id="ijsc-insertCtag" class="ijsc-view" style="display:none;">
            
            <div class="updated" id="ijsc-ctag-message" style="text-align:justify;">
                <p>
                    <?php
                    _e('Enter any tag element, in the right order. It will be inserted into &lt;head&gt; element of the page. WARNING: avoid typos!', 'ijsc'); 
                    ?>
                </p>                
            </div>
            <div style="margin:16px;">
                <textarea id="ijsc-ctag-code" style="width:100%;resize:none;font-family:monospace;"></textarea>
            </div>
            
        </div>
        
        <div id="ijsc-insertData" class="ijsc-view" style="display:none;">
            
            <div class="updated" id="ijsc-data-message" style="text-align:justify;">
                <p>
                    <?php
                    _e('Enter a link element to the resource of data (json or xml). It will be inserted into &lt;head&gt; element of the page. You can refer to this data file with something similar to jQuery("link[rel=\'data\']").attr("href").', 'ijsc'); 
                    ?>
                </p>                
            </div>
            <div style="margin:16px;">
                <textarea id="ijsc-data-code" style="width:100%;resize:none;font-family:monospace;"></textarea>
            </div>
            
        </div>
        
        <div id="ijsc-insertRawData" class="ijsc-view" style="display:none;">
            
            <div class="updated" id="ijsc-rawdata-message" style="text-align:justify;">
                <p>
                    <?php
                    _e('Enter raw data in a js fashion, i.e. var data = [1,2,3];. It will be inserted into &lt;head&gt; element of the page.', 'ijsc'); 
                    ?>
                </p>                
            </div>
            <div style="margin:16px;">
                <textarea id="ijsc-rawdata-code" style="width:100%;resize:none;font-family:monospace;"></textarea>
            </div>
            
        </div>
        
        <div id="ijsc-insertJSlib" class="ijsc-view" style="display:none;">
            <div class="updated" id="ijsc-jslib-message" style="text-align:justify;">
                <p>
                    <?php
                    _e('Use the field below to include JavaScript libraries on this post or page. Any URL inserted will be included in the &lt;head&gt; section of your page. You can insert many URLs, one for each line. Paths can be absolute or relative and lines order could be important.', 'ijsc'); 
                    ?>
                </p>                
            </div>
            <div style="margin: 16px;">
                <textarea id="ijsc-jslib-code" style="width:100%;resize:none;font-family:monospace;"></textarea>
            </div>
        </div>

        <div id="ijsc-insertJS" class="ijsc-view">
            <div class="updated" id="ijsc-js-message" style="text-align:justify;">
                <p>
                    <?php
            ...
            <div style="margin: 16px;">
                <textarea id="ijsc-js-code" style="width:100%;resize:none;font-family:monospace;"></textarea>
            </div>
        </div>
        
        <div id="ijsc-insertCSSlink" class="ijsc-view" style="display:none;">
            <div class="updated" id="ijsc-csslink-message" style="text-align:justify;">
                <p>
                    <?php
                    _e('Use the field below to include CSS external resources on this post or page. Any URL inserted will be included in the &lt;head&gt; section of your page via HeadJS. You can insert many URLs, one for each line. Paths can be absolute or relative and lines order could be important.', 'ijsc'); 
                    ?>
                </p>                
            </div>
            <div style="margin: 16px;">
                <textarea id="ijsc-csslink-code" style="width:100%;resize:none;font-family:monospace;"></textarea>
            </div>
        </div>

        <div id="ijsc-insertCSS" class="ijsc-view" style="display:none;">
            
            <div class="updated" id="ijsc-css-message" style="text-align:justify;">
                <p>
                    <?php
            ...
            <div style="margin:16px;">
                <textarea id="ijsc-css-code" style="width:100%;resize:none;font-family:monospace;"></textarea>
            </div>
