...
Adds fields to the post and page edit pages that allow you to insert JavaScript libraries, custom JavaScript or CSS for that
post or page. 
...
Now you can also dinamically load javascript library thanks to HeadJS and relative plugin.
